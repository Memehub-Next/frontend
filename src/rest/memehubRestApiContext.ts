...
import { QueryOperation } from "./memehubRestApiComponents";

export type MemehubRestApiContext = {
  fetcherOptions: {
    /**
 ...
 */
export function useMemehubRestApiContext<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey
>(_queryOptions?: Omit<UseQueryOptions<TQueryFnData, TError, TData, TQueryKey>, "queryKey" | "queryFn">): MemehubRestApiContext {
  return {
    fetcherOptions: {},
    queryOptions: {},
    queryKeyFn,
